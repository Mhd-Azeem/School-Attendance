...
android {
 ...
 defaultConfig {
  applicationId="com.azeem.schoolattendance"; minSdk=26; targetSdk=36
  versionCode=(System.getenv("BUILD_VERSION_CODE")?.toIntOrNull() ?: 47)
  versionName=System.getenv("BUILD_VERSION_NAME") ?: "0.2.35"
 }
