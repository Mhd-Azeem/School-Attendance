...
interface AuthState{session:string|null;profile:Profile|null;loading:boolean;login:(username:string,password:string)=>Promise<void>;signOut:()=>Promise<void>}
const AuthContext=createContext<AuthState>({session:null,profile:null,loading:true,login:async()=>{},signOut:async()=>{}})
export function AuthProvider({children}:{children:ReactNode}){
 ...
 return <AuthContext.Provider value={{session,profile,loading,login,signOut}}>{children}</AuthContext.Provider>
}
