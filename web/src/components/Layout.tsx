...
const adminLinks=[['/','Home',LayoutDashboard],['/attendance','Attendance',ClipboardCheck],['/students','Students',GraduationCap],['/teachers','Teachers',Users],['/reports','Reports',BarChart3],['/calendar','Calendar',CalendarDays],['/audit','Audit',History],['/settings','Settings',Settings],['/profile','Profile',UserRound]] as const
