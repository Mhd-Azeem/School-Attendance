...
export function Settings(){
 ...
 const [students,setStudents]=useState<any[]>([]),[search,setSearch]=useState(''),[deleting,setDeleting]=useState<string|null>(null)
 ...
 useEffect(()=>{if(admin)api<{settings:any}>('/api/settings').then(x=>setS(x.settings)).catch(()=>setError('Could not load system settings.'));loadStudents()},[admin])
