...
export interface Profile{id:string;full_name:string;username?:string;role:Role;is_active:boolean}
...
export interface Draft{classId:string;date:string;statuses:Partial<Record<string,AttendanceStatus>>;updatedAt:string}
